let handler = async (m, { conn, usedPrefix, command}) => {
      ...
      switch (command) {
        case 'list':
lkr = "I am Homelander, the epitome of strength and power. My presence commands respect, and my authority is absolute. Bow before me, for I am the one true leader.";
break;
   ...
   𝙃𝙊𝙈𝙀𝙇𝘼𝙉𝘿𝙀𝙍`; // Your bot menu message here
          break;
        case 'ownermenu':
          lkr = `❀° ┄──•••───╮
          𝙊𝙒𝙉𝙀𝙍 𝙈𝙀𝙉𝙐  
